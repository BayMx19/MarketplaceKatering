...
<head>
    ...
    <title>@yield('title') | KateringKu.</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6 kiri">
                    <p class="auth-text">KateringKu.</p>
                </div>
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="header-login">
                                <h3 class="text-header">Daftar</h3>
                            </div>
                            <div class="container ">
                                <div class="row login-form">
                                    <form class="mt-2" method="POST" action="{{ route('register') }}">
                                        ...
                                        <label for="name" class="label-form mt-3  mb-1">Nama</label>

                                        <input type="text" class="form-control form-login mt-2" id="name"
                                            placeholder="Masukkan Nama" name="name" required autocomplete="off">
